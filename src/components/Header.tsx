...
<NavbarBrand className="ml-[-140px]">
  ...
  <div className="flex items-center gap-4">
   ...
   <Modal backdrop={backdrop} isOpen={isOpen} onClose={onClose} radius="none">
        <ModalContent>
          {() => (
            <>
              ...
              <ModalBody>
                <Input label="Email" type="email" variant="flat" radius="none" size="sm"/>
                 <Input radius="none" variant="flat" size="sm"
    ...
    />
    <Button size="lg" className="bg-black text-white border-none" variant="faded" radius="none" onPress={handleLogin}>
      Log in
    </Button>
       
         
    <Button size="lg" className="bg-gray-200 text-black border-none" radius="none" variant="faded">
